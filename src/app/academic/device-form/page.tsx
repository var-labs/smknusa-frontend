...
const Page = () => {
  ...
  return (
    <ClientOnly>
      ...
      >
        <div className="pb-20 flex flex-col items-center w-full justify-center gap-10 max-w-full md:max-w-md-content lg:max-w-lg-content xl:max-w-[932px] 2xl:max-w-max-container ">
          <TeachingDeviceForm
